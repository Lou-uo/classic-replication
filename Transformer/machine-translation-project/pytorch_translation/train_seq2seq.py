...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr_gamma', default=0.98, type=float, help='learning rate decrease rate')
    parser.add_argument('--tp_prob', default=1, type=float, help='initial teacher forcing probability')
    parser.add_argument('--tp_gamma', default=0.99, type=float, help='teacher forcing decrease rate')
